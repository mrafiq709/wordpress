...
<div id='section-<?php echo wpqa_user_title()?>' class="section-referral">
	...
	<div class="referral-stats all-things-boxed">
		<ul class="row">
			<?php $invitations_sent = get_user_meta($wpqa_user_id,"invitations_sent",true);
			...
			<li class="col col3 referral-sent">
				<div>
			...
			<li class="col col3 referral-pending">
				<div>
			...
			<li class="col col3 referral-completed">
				<div>
					...
					for ($i = $points_referrals_count-$start; $i > $points_referrals_count-$end; $i--) {
						if ($k == 0) {?>
							<li class="<?php echo (++$k%2?"referral-odd":"referral-even")?>">
								...
								<div>
									<div class="row">
										<span class="col col5 referral-email"><?php esc_html_e("Email","wpqa")?></span>
										<span class="col col3 referral-status"><?php esc_html_e("Status","wpqa")?></span>
										<span class="col col2 referral-action"><?php esc_html_e("Action","wpqa")?></span>
						...
						<li class="<?php echo (++$k%2?"referral-odd":"referral-even")?>">
							...
							<div>
								<div class="row">
									<span class="col col5 referral-email"><?php echo esc_html($points_referral["email"])?></span>
									<span class="col col3 referral-status"><?php echo esc_html($points_referral["status"])?></span>
									<span class="col col2 referral-action">
