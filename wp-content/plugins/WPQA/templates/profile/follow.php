...
if (wpqa_is_user_followers() || wpqa_is_user_following() || $last_one == "followers" || $last_one == "following") {
	...
	if (isset($follow_user) && is_array($follow_user) && !empty($follow_user)) {
		...
		if ($total_users > $total_query) {
			echo '<div class="'.($user_style_pages == "grid" || $user_style_pages == "small" || $user_style_pages == "columns" || $user_style_pages == "small_grid"?"pagination-users ":"").'main-pagination"><div class="pagination">'.
