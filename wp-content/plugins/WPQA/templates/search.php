		...
		if ($search_value != "") {
			...
			<section>
				<?php if ( isset($wpqa_query) && $wpqa_query->have_posts() ) :
					...
					<div class="post-articles<?php echo (isset($its_question) && $its_question == "question"?" question-articles".(isset($question_columns) && $question_columns == "style_2"?" row".(isset($masonry_style) && $masonry_style == "on"?" isotope":""):""):"").($post_pagination == "none"?" no-pagination":"").(empty($more_link)?" articles-no-pagination":"")?>">
