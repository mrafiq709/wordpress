...
if (!function_exists('wpqa_send_invitation')) :
	function wpqa_send_invitation() {
		...
		if (isset($user->first_name)) {
			...
			$send_text = wpqa_send_email(wpqa_options("email_new_invitation"),$user_id,0,0,"","","","","","","","","","","","","",0,$invitation_link);
			...
			wpqa_sendEmail($email_template,get_bloginfo('name'),$email,$the_author,$email_title,$last_message_email);
