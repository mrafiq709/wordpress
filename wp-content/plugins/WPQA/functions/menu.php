...
function wpqa_wp_nav_menu_items($items,$args) {
	$slug = $args->menu;
	if (is_user_logged_in() && (isset($slug->slug) && $slug->slug == 'explore')) {
