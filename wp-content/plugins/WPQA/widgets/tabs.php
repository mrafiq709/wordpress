						...
						<?php foreach ($tabs as $key => $value) {
							if (isset($value["value"])) {
								if ($value["value"] == "display_posts") {?>
									<li class="tab"><a href="#"><?php if ($orderby == "no_response") {echo ($post_or_question == "question"?esc_html__('No answers','wpqa'):esc_html__('No comments','wpqa'));}elseif ($orderby == "most_voted") {esc_html_e('Most voted','wpqa');}elseif ($orderby == "most_visited") {esc_html_e('Most visited','wpqa');}elseif ($orderby == "most_rated") {esc_html_e('Most rated','wpqa');}elseif ($orderby == "popular") {esc_html_e('Popular','wpqa');}elseif ($orderby == "random") {esc_html_e('Rand','wpqa');}else {esc_html_e('Recent','wpqa');}?></a></li>
