    ...
    <div class="wrap about-wrap journalistblogily-add-css">
        <div>
            ...
            <div class="feature-section three-col">
                ...
                <div class="col">
                    <div class="widgets-holder-wrap">
                        <h3><?php echo __("Review Journalist Blogily", "journalistblogily"); ?></h3>
                        <p><?php echo __("Nothing motivates us more than feedback, are you are enjoying Journalist Blogily? We would love to hear what you think!", "journalistblogily"); ?></p>
                        <p><a target="blank" href="<?php echo esc_url('https://wordpress.org/support/theme/journalistblogily/reviews/', 'journalistblogily'); ?>" class="button button-primary">
                                <?php echo __("Submit A Review", "journalistblogily"); ?>
                            </a></p>
                    </div>
                </div>
                <div class="col">
 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Journalistblogily for publication on WordPress.org
...
add_action('tgmpa_register', 'journalistblogily_register_required_plugins');
 ...
 */
function journalistblogily_register_required_plugins()
{
    /*
     ...
     */
    $config = array(
        'id'           => 'journalistblogily',                 // Unique ID for hashing notices for multiple instances of TGMPA.
